...
area = abs(coor1[0] * (coor2[1] - coor3[1]) + coor2[0] * (coor3[1] - coor1[1]) + coor3[0] * (coor1[1] - coor2[1])) / 2 # calculate the area of the triangle using determinants of the matrix
